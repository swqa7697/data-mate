...
| `make clean` / `make uninstall`            | Remove owned installation resources while preserving profiles and credentials |
| `make uninstall PURGE=1`                   | Also delete owned profiles, credentials, host pins, and the installation key  |
