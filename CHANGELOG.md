...
- Add staged `db test [alias]` diagnostics with versioned JSON, safe errors, a `read_only` transaction check, and continued testing after individual connection failures.
